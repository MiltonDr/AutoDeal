...
const clienteApi = require('./application/entitie/cliente/ApiCliente');
...
app.listen(PORT, () => {
  ...
  console.log(`Get operation available at http://localhost:${PORT}/operaciongetclienteparametro/parametro`);
